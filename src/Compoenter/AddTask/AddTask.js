...
const AddTask = () => {
    ...
    return (
        <div className='md:w-9/12 mx-auto px-10 md:px-0 mb-10'>
            <h1 className='text-center text-2xl md:text-3xl font-bold'><span className='text-violet-500'>Added</span> Task </h1>

            <div className='flex justify-center items-center'>
                <form onSubmit={handleSubmit(addTaskSubmit)}>
                    <div className="form-control w-full   ">
                        ...
                        )} type="Date" placeholder="Today Date" className="input input-bordered w-full " />
                        {
                    ...
                    <div className="form-control ">
                        ...
                        <textarea {...register("Details",
                            { required: 'This  is required' }
                        )} type="text" placeholder="Today Date" className="input input-bordered w-full  pt-2 textarea textarea-primary h-52" />
                        {
                            errors.name && <p role='alert' className='text-red-500'>{errors.email?.message}</p>
                        }
                    </div>
